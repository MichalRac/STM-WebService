...
import com.example.stm_client.IMapProviderListener;
...
public class MapRequestHandler {
    ...
    public void SendRequest(IMapProviderListener listener, Double latMin, Double latMax, Double longMin, Double longMax ) {
        thread = new Thread() {
            public void run() {
                try {
